...
| bug-00028 | 演义域片段不足以支撑结论仍凭先验作答（「马超投靠刘备后」答案对但注入片段无五虎/病逝、「夏侯渊字什么」原文无此信息却答妙才；提示词含禁用先验约束但模型不服从 + 引用不支撑结论）。修复口径＝待定（负责人 2026-09-24：不排期不安排修改）：引用与结论关联校验 / 无支撑片段直回「演义中未涉及」 | mcp-orchestrator, mcp-server | feat-A004 | 待修复 | — |
