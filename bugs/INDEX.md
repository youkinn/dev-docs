...
| bug-00024 | 同题两次请求答案渲染不一致（「三英战吕布」一条 answer 只有角标 ¹ ² 无引语正文，trace 932d36fc / 5018ace0，citations 相同） | mcp-orchestrator | feat-A006 | 修复中 | — |
| bug-00025 | 演义域答案内联服务端内部编号 ⟨Qn⟩（问「孙尚香后来怎么样了」→ answer 出现 ⟨Q6⟩~⟨Q15⟩，trace 20117022；模型抄写注入片段 + 渲染层未剥离内部标记 + H4 安全网不识别弯引号抄写） | mcp-orchestrator | feat-A006 | 修复中 | — |
